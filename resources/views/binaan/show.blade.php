            ...
            <div class="space-y-8">
                    ...
                    <div class="grid lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden h-fit">
                                ...
                                <div class="p-6 max-h-[510px] overflow-y-auto">
                ...
                <div id="galeri" class="tab-content hidden">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-8">
                            <!-- Grid Galeri otomatis -->
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4"
                                id="gallery-grid">
                                @foreach ($mitras->galeri as $foto)
                                    <div class="gallery-item relative group cursor-pointer overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-300"
                                        ...
                                        <!-- Thumbnail -->
                                        <div
                                            class="aspect-square flex items-center justify-center bg-gray-100 overflow-hidden">
                                            <img src="{{ $foto['url'] }}" alt="{{ $foto['judul'] ?? 'Foto galeri' }}"
